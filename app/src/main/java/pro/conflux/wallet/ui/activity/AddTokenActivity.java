...
public class AddTokenActivity extends BaseActivity {
    ...
    public void initDatas() {
        ...
        mItems.add(new TokenItem(new TokenInfo("0x88e2541ecee0086efc8b1b4fa8a43f83d66053e3", "Fans Coin", "FC", 18), false, R.mipmap.fc_token));
        mItems.add(new TokenItem(new TokenInfo("0x893020562fc18bdf597fc06d04da2ceb95cdd9a0", "烤仔", "烤仔", 18), false, R.mipmap.fc_token));
