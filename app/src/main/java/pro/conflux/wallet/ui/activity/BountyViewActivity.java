 ...
 */
public class BountyViewActivity extends BaseActivity {
...
//    ProgressBar progressBar;
    ...
    public int getLayoutId() {
        return R.layout.activity_view_bounty;
    }
    ...
    public void configViews() {
        ...
        mWebview.loadUrl("https://bounty.conflux-chain.org");
        ...
        String cacheDirPath = getFilesDir().getAbsolutePath() + "/dapp/bounty";
...
//                super.onProgressChanged(view, newProgress);
            ...
            public boolean onJsConfirm(WebView view, String url, String message, final JsResult result) {
                new AlertDialog.Builder(BountyViewActivity.this)
                        .setTitle("JsConfirm")
                        .setMessage(message)
