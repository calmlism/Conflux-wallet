...
import pro.conflux.wallet.interact.ModifyWalletInteract;
import pro.conflux.wallet.utils.Md5Utils;
import pro.conflux.wallet.utils.TKeybord;
import pro.conflux.wallet.utils.ToastUtils;
import pro.conflux.wallet.utils.WalletDaoUtils;
import pro.conflux.wallet.view.InputPwdDialog;
import pro.conflux.wallet.view.PrivateKeyDerivetDialog;
...
public class WalletDetailActivity extends BaseActivity {
    ...
    @BindView(R.id.tv_cfx_balance)
    TextView tvCfxBalance;
    ...
    public void modifyPwdSuccess(CfxWallet wallet) {
