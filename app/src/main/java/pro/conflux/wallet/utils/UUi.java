...
//    }
    ...
    public static int dip2px(float dipValue) {
        float scale = ChainWalletApp.getsInstance().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        float fontScale = ChainWalletApp.getsInstance().getResources().getDisplayMetrics().scaledDensity;
