...
import pro.conflux.wallet.utils.bip44.ec.EcTools;
...
public class InMemoryPrivateKey extends PrivateKey implements KeyExporter, Serializable {
   ...
   @Override
   public pro.conflux.wallet.utils.bip44.PublicKey getPublicKey() {
      return _publicKey;
   }
   ...
   @Override
   protected pro.conflux.wallet.utils.bip44.Signature generateSignature(pro.conflux.wallet.utils.bip44.Sha256Hash messageHash) {
      return generateSignatureInternal(messageHash, new DsaSignatureNonceGenDeterministic(messageHash, this));
   }

   @Override
   protected pro.conflux.wallet.utils.bip44.Signature generateSignature(pro.conflux.wallet.utils.bip44.Sha256Hash messageHash, pro.conflux.wallet.utils.bip44.RandomSource randomSource) {
   ...
   @Override
   public String getBase58EncodedPrivateKey(pro.conflux.wallet.utils.bip44.NetworkParameters network) {
