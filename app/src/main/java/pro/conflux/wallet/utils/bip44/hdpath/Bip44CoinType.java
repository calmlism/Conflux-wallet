package pro.conflux.wallet.utils.bip44.hdpath;

import pro.conflux.wallet.utils.bip44.NetworkParameters;
...
public class Bip44CoinType extends Bip44Purpose  {
   ...
   @Override
   protected pro.conflux.wallet.utils.bip44.hdpath.HdKeyPath knownChildFactory(UnsignedInteger index, boolean hardened) {
      if (hardened){
