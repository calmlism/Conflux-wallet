...
import pro.conflux.wallet.utils.bip44.hdpath.HdKeyPath;
...
public class HdKeyNode implements Serializable {
    ...
    * Serialize this node
    */
   public String serialize(pro.conflux.wallet.utils.bip44.NetworkParameters network) throws KeyGenerationException {
